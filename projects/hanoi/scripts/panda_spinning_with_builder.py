...
from mujoco_xml_builder import create_scene_with_robot, MuJoCoXMLBuilder
...
def main():
    ...
    try:
        ...
        # Optionally save the generated XML for debugging
        builder.save_xml("debug_generated_scene.xml")
